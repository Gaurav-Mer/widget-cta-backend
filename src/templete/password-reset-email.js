...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hi User,</p>
            <p>We received a request to reset your password for your Mentor Paw account. Click the button below to reset it:</p>
            <a href="${resetUrl}" class="btn">Reset My Password</a>
            <p>If the button above doesn't work, copy and paste this link into your browser:</p>
            <p><a href="[reset-password-link]" style="color: #FF6B00;">${resetUrl}</a></p>
            <p>If you did not request a password reset, please ignore this email or contact our support team for help.</p>
        </div>
        <div class="warning">
